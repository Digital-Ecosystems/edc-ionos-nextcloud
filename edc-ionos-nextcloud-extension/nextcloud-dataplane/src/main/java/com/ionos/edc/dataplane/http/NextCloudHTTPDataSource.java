...
public class NextCloudHTTPDataSource implements DataSource {
    ...
    public Stream<Part> openPartStreamPart() {

        return Stream.of(new nextCloudPart(nextCloudApi, fileName, filePath, url, downloadable));
    ...
    public static class Builder {
        private final NextCloudHTTPDataSource source;
        public Builder fileName;


        private Builder() {
            source = new NextCloudHTTPDataSource();
        }
        ...
        public NextCloudHTTPDataSource build() {
            return source;
        }
