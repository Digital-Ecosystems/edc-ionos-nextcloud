...
public class NextCloudHTTPDataSink extends ParallelSink {

    private NextCloudApi nextCloudApi;
    private String filePath;
    private String fileName;
    private Boolean downloadable;
    public NextCloudHTTPDataSink() {
    }
    ...
    private StreamResult<Object> uploadFailure(Exception e, String fileName) {
        ...
        monitor.info("Transfer failed");
        return StreamResult.error(message);
    }


    public static class Builder extends ParallelSink.Builder<Builder, NextCloudHTTPDataSink> {
        private Builder() {
            super(new NextCloudHTTPDataSink());
        }
