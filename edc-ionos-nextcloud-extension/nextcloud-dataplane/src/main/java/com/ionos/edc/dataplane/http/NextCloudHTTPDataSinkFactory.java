...
public class NextCloudHTTPDataSinkFactory implements DataSinkFactory {
    ...
    public NextCloudHTTPDataSinkFactory(@NotNull ExecutorService executorService, Monitor monitor, Vault vault, TypeManager typeManager, NextCloudApi nextCloudApi) {
    ...
    public DataSink createSink(DataFlowRequest request) {
        ...
        if (secret != null) {
            var token = typeManager.readValue(secret, NextCloudToken.class);
                ...
                return NextCloudHTTPDataSink.Builder.newInstance()
