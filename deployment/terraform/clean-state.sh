...
rm -rf ./nextcloud-deploy/.terraform
rm -f ./nextcloud-deploy/terraform.tfstate
rm -f ./nextcloud-deploy/.terraform.lock.hcl
rm -f ./nextcloud-deploy/terraform.tfstate.backup
