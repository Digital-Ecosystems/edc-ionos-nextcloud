...
rm -rf ./nenextcloud-deploy/.terraform
rm -f ./nenextcloud-deploy/terraform.tfstate
rm -f ./nenextcloud-deploy/.terraform.lock.hcl
rm -f ./nenextcloud-deploy/terraform.tfstate.backup
